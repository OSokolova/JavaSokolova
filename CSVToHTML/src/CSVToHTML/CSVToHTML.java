...
public class CSVToHTML {
    public static void main(String[] args) throws FileNotFoundException {
        try (PrintWriter writer = new PrintWriter(args[0]);
            ...
            writer.println("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\"" + System.lineSeparator() +
                    " \"http://www.w3.org/TR/html4/strict.dtd\">" + System.lineSeparator() +
                    "<html>" + System.lineSeparator() +
                    "<head>" + System.lineSeparator() +
                    "<title> Проверка выполнения кода по конвертированию CSV-файла в HTML-файл </title>" + System.lineSeparator() +
                    "</head>" + System.lineSeparator() +
            ...
            writer.println("</table>" + System.lineSeparator() + "</body>" + System.lineSeparator() +
                    "</html>");
        }
    }
}
